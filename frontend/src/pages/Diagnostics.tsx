...
const Diagnostics: React.FC = () => {
  ...
  return (
    <WindowFrame
      title="系统诊断"
      subtitle="启动前检查数据库、Redis、Dolphin、IMAP 和关键环境变量，定位流程失败点。"
      ...
      <div className="grid gap-5 xl:grid-cols-[0.9fr_1.1fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>真实连接数据库、Redis、Dolphin API 和 IMAP。</CardDescription>
          </CardHeader>
          ...
          <Card>
            <CardContent className="grid gap-3 p-5 sm:grid-cols-3">
              {[
                ...
                ['Dolphin', serviceChecks.find(item => item.key === 'dolphin')?.status, <RiWifiLine className="size-5" />],
